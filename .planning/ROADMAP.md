...
Plans:
- [x] 01-01-PLAN.md — Install i18next packages, create config, wire into main.tsx
- [x] 01-02-PLAN.md — Extract Spanish content, generate English translations, create validation script
