          ...
          {Array.from({ length: 3 }).map((_, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative p-8 rounded-3xl bg-gradient-to-br from-card/80 to-card/40 backdrop-blur-sm border border-border/50 hover:border-accent/40 hover:shadow-[0_0_60px_-12px_hsl(var(--accent)/0.2)] transition-all duration-500"
              >
                {/* Subtle gradient orb */}
